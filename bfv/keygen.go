...
type KeyGenerator interface {
	...
	GenRelinearizationKey(sk *rlwe.SecretKey, maxDegree uint64) (evk *rlwe.RelinearizationKey)
...
func (keygen *keyGenerator) GenRelinearizationKey(sk *rlwe.SecretKey, maxDegree uint64) (evk *rlwe.RelinearizationKey) {
