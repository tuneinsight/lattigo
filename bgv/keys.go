...
// NewPublicKey returns an allocated BGV public with zero values.
...
// NewRelinearizationKey returns an allocated BGV public relinearization key with zero value for each degree in [2 < maxRelinDegree].
