...
func NewEvaluator(btpParams Parameters, evk *EvaluationKeys) (eval *Evaluator, err error) {
	...
	eval.Mod1Evaluator = mod1.NewMod1Evaluator(eval.Evaluator, polyfloat.NewPolynomialEvaluator(params, eval.Evaluator), eval.Mod1Parameters)
...
func (eval Evaluator) ShallowCopy() *Evaluator {
	...
	return &Evaluator{
		...
		Mod1Evaluator:  mod1.NewMod1Evaluator(heEvaluator, polyfloat.NewPolynomialEvaluator(params, heEvaluator), eval.Mod1Parameters),
	}
}
