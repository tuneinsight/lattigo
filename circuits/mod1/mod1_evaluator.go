...
type Mod1Evaluator struct {
	*ckks.Evaluator
	PolynomialEvaluator *polyfloat.PolynomialEvaluator
...
func NewMod1Evaluator(eval *ckks.Evaluator, evalPoly *polyfloat.PolynomialEvaluator, Mod1Parameters Mod1Parameters) *Mod1Evaluator {
