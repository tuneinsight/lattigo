...
func benchEncoder(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Encoder/Encode/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Encoder/Decode/"), func(b *testing.B) {
...
func benchKeyGen(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "KeyGen/KeyPairGen/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			kgen.GenKeyPair()
		}
	})

	b.Run(ParamsToString(testContext.params, "KeyGen/SwitchKeyGen/"), func(b *testing.B) {
...
func benchEncrypt(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Encrypt/key=Pk/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "EncryptFast/key=Pk/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			encryptorPkFast.Encrypt(plaintext, ciphertext)
		}
	})

	b.Run(ParamsToString(testContext.params, "Encrypt/key=Sk/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
...
func benchDecrypt(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Decrypt/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
...
func benchEvaluator(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Evaluator/Add/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.Add(ciphertext1, ciphertext2, ciphertext1)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/AddScalar/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.AddConst(ciphertext1, ciphertext2, ciphertext1)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/MulScalar/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.MultByConst(ciphertext1, complex(3.1415, -1.4142), ciphertext1)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/MulPlain/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.Mul(ciphertext1, plaintext, ciphertext1)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/Mul/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.Mul(ciphertext1, ciphertext2, receiver)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/Square/"), func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			eval.Mul(ciphertext1, ciphertext1, receiver)
		}
	})

	b.Run(ParamsToString(testContext.params, "Evaluator/Rescale/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Evaluator/PermuteNTT/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Evaluator/Conjugate/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Evaluator/Relin/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "Evaluator/Rotate/"), func(b *testing.B) {
...
func benchInnerSum(testContext *testParams, b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "InnerSum/"), func(b *testing.B) {
	...
	b.Run(ParamsToString(testContext.params, "InnerSumLog/"), func(b *testing.B) {
