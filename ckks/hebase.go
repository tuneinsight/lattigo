...
func NewLinearTransformation[T Float](params rlwe.ParameterProvider, lt hebase.LinearTranfromationParameters[T]) hebase.LinearTransformation {
...
func GaloisElementsForLinearTransformation[T Float](params rlwe.ParameterProvider, lt hebase.LinearTranfromationParameters[T]) (galEls []uint64) {
