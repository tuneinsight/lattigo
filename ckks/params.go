...
func NewParametersFromModuli(logN uint64, m *rlwe.Moduli, sigma float64, logSlots uint64, scale float64) (p *ParametersStruct, err error) {
...
func NewParametersFromLogModuli(logN uint64, lm *rlwe.LogModuli, sigma float64, logSlots uint64, scale float64) (p *ParametersStruct, err error) {
...
func (p *ParametersStruct) LogSlots() uint64 {
	return p.logSlots
}

// MaxLevel returns the maximum ciphertext level
func (p *ParametersStruct) MaxLevel() uint64 {
	return p.QCount() - 1
}
