...
func NewE2SProtocol(params bfv.Parameters, noise distribution.Distribution) *E2SProtocol {
	e2s := new(E2SProtocol)
...
func NewS2EProtocol(params bfv.Parameters, noise distribution.Distribution) *S2EProtocol {
	s2e := new(S2EProtocol)
