...
func (share *CKGShare) MarshalBinarySize() int {
	return share.Value.MarshalBinarySize64()
}
...
func (share *CKGShare) MarshalBinaryInPlace(data []byte) (ptr int, err error) {
	return share.Value.Encode64(data)
}
...
func (share *CKGShare) UnmarshalBinaryInPlace(data []byte) (ptr int, err error) {
	return share.Value.Decode64(data)
}
