...
func (share PublicKeySwitchShare) BinarySize() int {
	return share.Operand.BinarySize()
}
...
func (share PublicKeySwitchShare) WriteTo(w io.Writer) (n int64, err error) {
	return share.Operand.WriteTo(w)
}
