...
func (s *ShamirSecretShare) MarshalBinarySize() int {
	return s.Poly.MarshalBinarySize64()
}
...
func (s *ShamirSecretShare) MarshalBinaryInPlace(data []byte) (ptr int, err error) {
	return s.Poly.Encode64(data)
}

// UnmarshalBinary decodes a slice of bytes generated by MarshalBinary
// or MarshalBinaryInPlace on the object.
func (s *ShamirSecretShare) UnmarshalBinary(data []byte) (err error) {
...
func (s *ShamirSecretShare) UnmarshalBinaryInPlace(data []byte) (ptr int, err error) {
	return s.Poly.Decode64(data)
}
