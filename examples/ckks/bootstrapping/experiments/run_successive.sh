...
./boot_precision -makeplot -logslot 15 -nboot 50 -paramSet 3 successive | tee out/successive_p4.tex
./boot_precision -makeplot -logslot 14 -nboot 50 -paramSet 4 successive | tee out/successive_p5.tex