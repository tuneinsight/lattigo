...
//
// >>>>>>>!WARNING!<<<<<<<
// The bootstrapping parameters use their own and independent cryptographic parameters (i.e. hefloat.Parameters)
...
// instantiated bootstrapper.Parameters struct which supports and API an identical to the hefloat.Parameters.
func NewParametersFromLiteral(paramsResidual hefloat.Parameters, paramsBootstrapping ParametersLiteral) (Parameters, error) {
