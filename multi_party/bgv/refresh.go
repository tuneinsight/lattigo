...
func (rfp RefreshProtocol) AllocateShare(inputLevel, outputLevel int) multi_party.RefreshShare {
...
func (rfp RefreshProtocol) GenShare(sk *rlwe.SecretKey, ct *rlwe.Ciphertext, crp multi_party.KeySwitchCRP, shareOut *multi_party.RefreshShare) (err error) {
...
func (rfp RefreshProtocol) AggregateShares(share1, share2 multi_party.RefreshShare, shareOut *multi_party.RefreshShare) (err error) {
	return rfp.MaskedTransformProtocol.AggregateShares(share1, share2, shareOut)
}

// Finalize applies Decrypt, Recode and Recrypt on the input ciphertext.
func (rfp RefreshProtocol) Finalize(ctIn *rlwe.Ciphertext, crp multi_party.KeySwitchCRP, share multi_party.RefreshShare, opOut *rlwe.Ciphertext) (err error) {
