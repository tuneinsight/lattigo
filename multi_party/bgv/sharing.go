...
func NewAdditiveShare(params bgv.Parameters) multi_party.AdditiveShare {
	return multi_party.NewAdditiveShare(params.RingT())
}
...
func NewEncToShareProtocol(params bgv.Parameters, noiseFlooding ring.DistributionParameters) (EncToShareProtocol, error) {
	...
	var err error
	if e2s.KeySwitchProtocol, err = multi_party.NewKeySwitchProtocol(params.Parameters, noiseFlooding); err != nil {
...
func (e2s EncToShareProtocol) GenShare(sk *rlwe.SecretKey, ct *rlwe.Ciphertext, secretShareOut *multi_party.AdditiveShare, publicShareOut *multi_party.KeySwitchShare) {
...
func (e2s EncToShareProtocol) GetShare(secretShare *multi_party.AdditiveShare, aggregatePublicShare multi_party.KeySwitchShare, ct *rlwe.Ciphertext, secretShareOut *multi_party.AdditiveShare) {
...
func NewShareToEncProtocol(params bgv.Parameters, noiseFlooding ring.DistributionParameters) (ShareToEncProtocol, error) {
	...
	var err error
	if s2e.KeySwitchProtocol, err = multi_party.NewKeySwitchProtocol(params.Parameters, noiseFlooding); err != nil {
...
func (s2e ShareToEncProtocol) GenShare(sk *rlwe.SecretKey, crp multi_party.KeySwitchCRP, secretShare multi_party.AdditiveShare, c0ShareOut *multi_party.KeySwitchShare) (err error) {
...
func (s2e ShareToEncProtocol) GetEncryption(c0Agg multi_party.KeySwitchShare, crp multi_party.KeySwitchCRP, opOut *rlwe.Ciphertext) (err error) {
	if opOut.Degree() != 1 {
