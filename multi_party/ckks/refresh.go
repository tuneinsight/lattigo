...
// value for logBound.
func (rfp RefreshProtocol) GenShare(sk *rlwe.SecretKey, logBound uint, ct *rlwe.Ciphertext, crs multi_party.KeySwitchCRP, shareOut *multi_party.RefreshShare) (err error) {
...
func (rfp RefreshProtocol) AggregateShares(share1, share2, shareOut *multi_party.RefreshShare) (err error) {
...
func (rfp RefreshProtocol) Finalize(ctIn *rlwe.Ciphertext, crs multi_party.KeySwitchCRP, share multi_party.RefreshShare, opOut *rlwe.Ciphertext) (err error) {
