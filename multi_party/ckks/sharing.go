...
func NewAdditiveShare(params ckks.Parameters, logSlots int) multi_party.AdditiveShareBigint {
	...
	return multi_party.NewAdditiveShareBigint(nValues)
}
...
func NewEncToShareProtocol(params ckks.Parameters, noise ring.DistributionParameters) (EncToShareProtocol, error) {
	...
	var err error
	if e2s.KeySwitchProtocol, err = multi_party.NewKeySwitchProtocol(params.Parameters, noise); err != nil {
...
func (e2s EncToShareProtocol) AllocateShare(level int) (share multi_party.KeySwitchShare) {
...
// value for logBound.
func (e2s EncToShareProtocol) GenShare(sk *rlwe.SecretKey, logBound uint, ct *rlwe.Ciphertext, secretShareOut *multi_party.AdditiveShareBigint, publicShareOut *multi_party.KeySwitchShare) (err error) {
...
func (e2s EncToShareProtocol) GetShare(secretShare *multi_party.AdditiveShareBigint, aggregatePublicShare multi_party.KeySwitchShare, ct *rlwe.Ciphertext, secretShareOut *multi_party.AdditiveShareBigint) {
...
func NewShareToEncProtocol(params ckks.Parameters, noise ring.DistributionParameters) (ShareToEncProtocol, error) {
	...
	var err error
	if s2e.KeySwitchProtocol, err = multi_party.NewKeySwitchProtocol(params.Parameters, noise); err != nil {
...
func (s2e ShareToEncProtocol) AllocateShare(level int) (share multi_party.KeySwitchShare) {
...
func (s2e ShareToEncProtocol) GenShare(sk *rlwe.SecretKey, crs multi_party.KeySwitchCRP, metadata *rlwe.MetaData, secretShare multi_party.AdditiveShareBigint, c0ShareOut *multi_party.KeySwitchShare) (err error) {
...
func (s2e ShareToEncProtocol) GetEncryption(c0Agg multi_party.KeySwitchShare, crs multi_party.KeySwitchCRP, opOut *rlwe.Ciphertext) (err error) {
	if opOut.Degree() != 1 {
