...
func (pol *Poly) WriteCoeffs(data []byte) (uint64, error) {
	...
	cnt, err := WriteCoeffsTo(0, pol.GetDegree(), pol.GetLenModuli(), pol.Coeffs, data)
	return cnt, err
