...
type Bootstrapper interface {
	...
	// Bootstrapp defines a method that takes a single Ciphertext as input and applies
	...
	// Depth is the number of levels consummed by the bootstrapping circuit.
	...
	// OuputLevel defines the level that the ciphertext will be at
