	...
	*ciphertext2.MetaData = *plaintext.MetaData
	...
	b.Run(name("EvaluatorParallel/Add/Scalar", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Add(ciphertext1, 3.1415-1.4142i, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Add/Scalar", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Add(ciphertext1, vector, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Add/Plaintext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Add(ciphertext1, plaintext, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Add/Ciphertext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Add(ciphertext1, ciphertext2, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Mul/Scalar", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Mul(ciphertext1, 3.1415-1.4142i, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Mul/Vector", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Mul(ciphertext1, vector, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Mul/Plaintext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Mul(ciphertext1, plaintext, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Mul/Ciphertext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Mul(ciphertext1, ciphertext2, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulRelin/Ciphertext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulRelin(ciphertext1, ciphertext2, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulThenAdd/Scalar", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulThenAdd(ciphertext1, 3.1415-1.4142i, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulThenAdd/Vector", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulThenAdd(ciphertext1, vector, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulThenAdd/Plaintext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulThenAdd(ciphertext1, plaintext, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulThenAdd/Ciphertext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulThenAdd(ciphertext1, ciphertext2, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/MulRelinThenAdd/Ciphertext", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.MulRelinThenAdd(ciphertext1, ciphertext2, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Rescale", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Rescale(ciphertext1, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
	...
	b.Run(name("EvaluatorParallel/Rotate", tc), func(b *testing.B) {
		...
		b.RunParallel(func(pb *testing.PB) {
			...
			evalCpy := eval.ShallowCopy()
			for pb.Next() {
				if err := evalCpy.Rotate(ciphertext1, 1, receiver); err != nil {
					b.Log(err)
					b.Fail()
				}
			}
