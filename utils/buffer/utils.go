...
// TestInterface is a testing interface for byte encoding and decoding.
...
func TestInterfaceWriteAndRead(t *testing.T, input TestInterface) {

	// Allocates a new object of the underlying type of input
	output := reflect.New(reflect.TypeOf(input).Elem()).Elem().Addr().Interface().(TestInterface)
