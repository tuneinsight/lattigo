...
// Set sets a Vector to the slice of T.
// Overwrites the current states of the Vector.
func (v *Vector[T]) Set(vi []*T) {
	*v = Vector[T](vi)
}

// Get returns the underlying slice of T.
func (v *Vector[T]) Get() (vi []*T) {
	return []*T(*v)
}
